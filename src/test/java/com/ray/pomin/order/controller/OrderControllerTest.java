                ...
                .andDo(
                        document("order/save",
                                responseFields(
                                        ...
                                        fieldWithPath("store.createdDate").type(JsonFieldType.NULL).description("가게 이름"),
                                        fieldWithPath("store.lastModifiedDate").type(JsonFieldType.NULL).description("가게 이름"),
                                        fieldWithPath("store.phoneNumber").type(JsonFieldType.STRING).description("가게 이름"),
                                        fieldWithPath("store.time").type(JsonFieldType.OBJECT).description("가게 이름"),
                                        fieldWithPath("store.time.open").type(JsonFieldType.STRING).description("가게 이름"),
                                        fieldWithPath("store.time.close").type(JsonFieldType.STRING).description("가게 이름"),
                                        fieldWithPath("store.storeImages").type(JsonFieldType.ARRAY).description("가게 이름"),
