...
public record StoreSaveRequest(Long id, String name, String phoneNumber, String mainAddress,
    ...
    public Store toEntity(Point addressPoint) {
        ...
        return new Store(id, name, phoneNumber, address, addressPoint, time, images);
    }
